...
from myhoard.apps.auth.views import UserList
...
current_app.api.add_resource(UserPublicCollectionList,
                             '/users/<ObjectId:user_id>/collections/')
...
current_app.api.add_resource(CollectionCommentList,
                             '/collections/<ObjectId:collection_id>/comments/')
